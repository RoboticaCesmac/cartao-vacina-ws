...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('images/icon/cit.png')}}" alt="Centro de Inovação Tecnológica" />
                        </a>
        ...
        <div class="logo">
                <a href="#">
                    <img src="{{asset('images/icon/cit-pb.png')}}" style="height: 50px" alt="Centro de Inovação Tecnológica" />
                </a>
            </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Centro de Inovação Tecnológica {{date('Y')}}. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
